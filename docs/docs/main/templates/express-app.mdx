...
the CLI will be used for both the app's directory and the package.json name. To
create the app in a specific directory, prepend the directory path to the name.
