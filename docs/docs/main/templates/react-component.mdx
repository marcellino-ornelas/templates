...
By default templates will generate a new folder for you. If you dont want a new
folder for your react component you can use
[`newFolder`](../../api/template#new-folder) option
...
```bash
tps react-component footer --no-newFolder
```
...
You can add the following to your `.tps/.tpsrc` file to always not use a new
folder when generating a react component in your repos directory and all its
subdirectories.
...
</Tabs>### How to use with typescript
