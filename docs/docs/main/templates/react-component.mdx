...
When your component uses typescript it will add a typesscript interface for the
component props and change the default value for the `extension` option to
`tsx`.
...
To generate your component using typescript, you can do one of the following:
