...
<div className="row" style={{ fontSize: 20 }}>
	...
	<div className="col col--6 display--flex align-items--center margin-bottom--xs">
		<Icon inline icon="logos:jest" width="25px" className="margin-right--xs" />{' '}
		Supports Unit tests
	</div>
	<div className="col col--6 display--flex align-items--center margin-bottom--xs">
		<Icon icon="skill-icons:css" width="25px" className="margin-right--xs" />{' '}
...
By default, this template will use a default export when exporting your new
component. If your repo use's a different type of export pattern, you can use
the `export` option. Currently only default exports and named exports are
supported. You can do this either on the command line or in your .tps/.tpsrc
file.

If you want to use a named export for your export pattern you can do one of the
following:
...
when generating your new component.
...
you can use the `typescript` option.

When the `typescript` option is provided, it will render your new component
using typescript. This will add a props interface to your component file and
change the default value for `extension` to `tsx`.
...
If you want a different extension than `tsx`, just change the value to what you
wish.
...
By default, this template will use a function declaration for your new
component. If your repo use's a different type of function pattern, you can use
the `functionStyle` option. Currently only arrow and function declaration styles
are supported. You can do this either on the command line or in your .tps/.tpsrc
file.

If you want to use a arrow function you can do one of the following:
...
functions when generating your new component.
