...
The name you pass in for your component will be used as the name of your folder
and component files. So if your repo uses
[param-case](../../api/template-context#paramCase),
[camelCase](../../api/template-context#camelCase), or
[snake_case](../../api/template-context#pascalCase) file name patterns, you can
also pass in those formats
