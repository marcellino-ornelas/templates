...
<div class="row" style={{ fontSize: 20 }}>
  <div class="col col--6">🎉 Supports Typescript</div>
  <div class="col col--6">📗 Supports Storybook</div>
  <div class="col col--6">🧪 Supports Unit tests</div>
  <div class="col col--6">💅 Supports multiple CSS languages</div>
</div>
