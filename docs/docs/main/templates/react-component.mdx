...
<div className="row" style={{ fontSize: 20 }}>
    ...
    <div className="col col--6 display--flex align-items--center margin-bottom--xs">
        ...
        <span>Automatic Formatting<Badge className="margin-left--sm" type="success">Beta</Badge></span>
    </div>
     <div className="col col--6 display--flex align-items--center margin-bottom--xs">
        <Icon icon="logos:eslint" width="25px" className="margin-right--xs" />
        <Icon icon="devicon:biome" width="25px" className="margin-right--xs" />

        <span>Automatic Lint Fixing<Badge className="margin-left--sm" type="success">Beta</Badge></span>
    </div>
