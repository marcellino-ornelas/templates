...
Please initialize your repo with templates before continuing. This will create
the necessary components needed in order to create a template

```bash
tps init
```

Its not required but you can read more about this
