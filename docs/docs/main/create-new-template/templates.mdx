...
rending files and folders and dynamiclly rendering files and folders.
...
Templates need to live in a `.tps` folder. Subdirectories of the `.tps`
directory are your templates. You may have as many templates as you wish.

:::tip

You can create this `.tps` folder by running the init command:
...
directory on your file system. This is useful if you have repository-specific
flows you are trying to automate. Local templates live in a `.tps` folder.
Subdirectories of the `.tps` directory are your templates.
