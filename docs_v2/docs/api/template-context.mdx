...
The tps.answers object holds the answers to the prompts in your templates. Each
prompt's value is stored with a property name that corresponds to the name you
assigned to the prompt in your settings.json file.
